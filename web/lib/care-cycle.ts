...
// tip: 그날 받은 시술의 홈케어 안내(방문 관리 화면에 그대로 보여줌 — 손님께 전할 말 겸 기억용)
export type Care = { cat: string; days: number; phrase: string; tip: string };
